            ...
            <div className="container">
                <header>
                    ...
                    <nav className="nav-list">
                        <Link to="/ghappydog/lost">유실동물</Link>
                        <Link to="/ghappydog/found">발견 동물</Link>
                    </nav>
                </header>
                <Routes>
                    <Route path="/ghappydog/lost" element={<LostAnimals lostAnimals={dogs} />} />
                    <Route path="/ghappydog/found" element={<FoundAnimals foundAnimals={foundDogs} />} />
                    <Route path="/ghappydog/dog-details/:name" element={<DogDetails animals={dogs.concat(foundDogs)} />} />
                </Routes>
            </div>
        </Router>
    );
